...
globalkeys = gears.table.join(
    ...
    -- Rofi
    awful.key({ "Mod1" }, "space", function() awful.spawn("rofi -show combi") end, {description = "run rofi", group = "launcher"}),
...
awful.spawn.with_shell("xrandr --output HDMI1 --auto --right-of eDP1")
...
awful.spawn.with_shell("redshift -l 41:-8 -t 5700:3600")
